...
* compare with more traditional AR approach
* loo (STAN model evaluation)
* Look at parameter convergence
...
>>>>>>> f3dd674ddfdfdf2dc521f4153f56a64821114292

>  Potter, Nicholas A. "Bayesian Inference: Insights into the Impacts of Minimum Wage Policies". Working Paper. 2017. Available: http://www.github.com/potterzot/bayesian-minwage.
...
```
<<<<<<< HEAD
install.packages(c("RCurl", "data.table", "bsts"))
...
3. Use it to access the data used in the project. This is best done by cloning the repository and typing `make data_all` in the repository directory.
